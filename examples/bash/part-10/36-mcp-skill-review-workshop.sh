#!/usr/bin/env bash
# Учебный сниппет для notes/part-10-course-appendix/36-mcp-skill-review-workshop.md
# Порт DescriptionLooksHostile: учебные маркеры в description. Не полный detector.
# Licensed under MIT (see LICENSE-CODE).
#
# Usage: bash examples/bash/part-10/36-mcp-skill-review-workshop.sh "описание инструмента"
