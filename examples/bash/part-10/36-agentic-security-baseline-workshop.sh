#!/usr/bin/env bash
# Учебный сниппет для notes/part-10-course-appendix/36-agentic-security-baseline-workshop.md
# Порт RejectFloating: запрет latest / * / ^ / ~ / пустой версии. Не дубль verify-pins.sh.
# Licensed under MIT (see LICENSE-CODE).
#
# Usage: bash examples/bash/part-10/36-agentic-security-baseline-workshop.sh <version>
