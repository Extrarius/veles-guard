#!/usr/bin/env bash
# Учебный сниппет для notes/part-10-course-appendix/35-course-appendix-agentic-security.md
# Порт идеи deny-by-default / allowlist tools. Не для production.
# Licensed under MIT (see LICENSE-CODE).
#
# Usage: bash examples/bash/part-10/35-course-appendix-agentic-security.sh <tool-name>
