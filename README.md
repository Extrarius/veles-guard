...
Конспект не претендует на роль стандарта и не заменяет OWASP / NIST / MITRE ATLAS. Это практическая карта тем, угроз и защитных подходов — основа для проектирования, ревью и развития собственных AI-агентов.
