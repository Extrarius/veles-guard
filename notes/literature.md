...
- **Check Point — When Agentic Glue Melts** — <https://research.checkpoint.com/2026/when-agentic-glue-melts/> — pin self-hosted workerd `v1.20260619.1`; опора §08 sandbox-runtime / EV-07 (`if glue holds the boundary, audit glue`).
